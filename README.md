...
> [!TIP]
> 最新版Docker镜像：`calciumion/Knight Omega:latest`  
...
#### 使用宝塔面板Docker功能部署
安装宝塔面板（**9.2.0版本**及以上），在应用商店中找到**Knight Omega**安装即可。
[图文教程](./docs/BT.md)
...
其他基于Knight Omega的项目：
- [Knight Omega-horizon](https://github.com/Calcium-Ion/Knight Omega-horizon)：Knight Omega高性能优化版
