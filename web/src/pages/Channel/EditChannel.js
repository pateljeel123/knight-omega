                ...
                <Card className="!rounded-2xl shadow-sm border-0 mb-6">
                  ...
                  {inputs.type === 8 && (
                    <>
                      <Banner
                        type='warning'
                        description={t('如果你对接的是上游Knight Omega或者Knight Omega等转发项目，请使用OpenAI类型，不要使用此类型，除非你知道你在做什么。')}
                        className='!rounded-lg'
                      />
                      <div>
                        <Form.Input
                  ...
                  <Form.TextArea
                    ...
                    extraText={(
                      <Space wrap>
                        ...
                        <Text
                          className="!text-semi-color-primary cursor-pointer"
                          onClick={() => window.open('http://localhost:5173//blob/main/docs/channel/other_setting.md')}
                        >
                          {t('设置说明')}
                        </Text>
                      </Space>
