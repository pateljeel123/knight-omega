    ...
    <footer className="relative h-auto py-16 px-6 md:px-24 w-full flex flex-col items-center justify-between overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 w-full">
            <div className="text-left">
              ...
              <div className="flex flex-col gap-4">
                <a href="http://localhost:5173/wiki/project-introduction/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('关于项目')}</a>
                <a href="http://localhost:5173/support/community-interaction/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('联系我们')}</a>
                <a href="http://localhost:5173/wiki/features-introduction/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('功能特性')}</a>
              </div>
            </div>
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col gap-4">
                <a href="http://localhost:5173/getting-started/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('快速开始')}</a>
                <a href="http://localhost:5173/installation/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('安装指南')}</a>
                <a href="http://localhost:5173/api/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('API 文档')}</a>
              </div>
            </div>
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col gap-4">
                <a href="https://github.com/songquanpeng/one-api" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">Knight Omega</a>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-[1110px] gap-6">
        ...
        <div className="text-sm">
          ...
          <a href="http://localhost:5173/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-primary font-medium">Knight Omega</a>
          <span className="!text-semi-color-text-1"> & </span>
          <a href="https://github.com/songquanpeng/one-api" target="_blank" rel="noopener noreferrer" className="!text-semi-color-primary font-medium">Knight Omega</a>
        </div>
      </div>
    </footer>
